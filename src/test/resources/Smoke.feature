...
Scenario:
An employee can view week of timesheets and timesheets for selected date 
	When the user launches the app 
	Then the user click on Get Started Button 
	And Enter employee username and password and click on Sign In button 
	Then the employee navigates to dashboard page 
...
@MOB-4257 @MOB-4265 @MOB-4267 @AndroidSmoke @MOB-4258 @MOB-4266 @MOB-4268
@iOSSmoke @sprint8 
...
Scenario:
An employee can add time to a timesheet and edit and delete the time from the timesheet 
	When the user launches the app 
	Then the user click on Get Started Button 
	And Enter employee username and password and click on Sign In button 
	Then the employee navigates to dashboard page 
...
#Scenario:
#Event should be display when user taps on any event, on any day from calendar 
#	When the user launches the app 
#	Then the user click on Get Started Button 
#	And Enter employee username and password and click on Sign In button 
#	Then the employee navigates to dashboard page 
...
Scenario:
The user with directory access can view the full directory list and details 
	When the user launches the app 
	Then the user click on Get Started Button 
