...
public class ApiMethods {
    ...
    public HttpResponse<String> getAbsenceFromDate(String token, String workerID, String absenceDay) throws Throwable {
        ...
        HttpResponse<String> response = Unirest
                ...
                .queryString("startDate", common.workingDay(absenceDay, "MM/dd/yyyy", 1))
                .queryString("endDate", common.workingDay(absenceDay, "MM/dd/yyyy",1))
...
//                .header("Authorization", "Basic c2hhbmtoYWJhZ2NoaV9IOWxvTWY6eE5rcGJmMVByMWV4cTRucXNoYmM=")
